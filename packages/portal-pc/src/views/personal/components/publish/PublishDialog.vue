      ...
      <div class="pdc-list">
        <div v-for="item in publishOptions" class="pdc-list-item">
          <div class="configure-left">
            ...
            />
            <svg class="ml-4 mr-2.5" v-if="item.id === 'telegram'" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
            ...
            <svg  class="ml-4 mr-2.5" v-if="item.id === 'discard'" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
