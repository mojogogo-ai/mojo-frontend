...
export default function createVitePlugins (viteEnv, isBuild = false) {
  ...
  let vitePlugins = [
    ...
    svgComponent({// svg组件插件 https://github.com/Jevon617/unplugin-svg-component/blob/main/README.zh_CN.md
      iconDir: [path.resolve(__dirname, '../../src/assets/svg')],
      componentName: 'SvgIcon',
      vueVersion: 3,
      treeShaking: false, // tree-shaking 开启会导致svg组件name动态获取时（name是变量），对应的svg图片不被打包，故不能启用。
    })
  ]
